    ...
    public partial class InitialMigrations : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AccountNumber = table.Column<int>(nullable: false, defaultValueSql: "NEXT VALUE FOR shared.AccountSequence"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Transactions", x => new { x.TransactionID, x.TransactionType });
